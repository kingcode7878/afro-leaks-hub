          ...
          <div className="absolute inset-0 z-[2000] bg-black flex flex-col h-full w-full overflow-hidden animate-in fade-in slide-in-from-bottom duration-300">
            ...
            <div className="absolute top-0 left-0 right-0 p-6 flex justify-between z-[2002] bg-gradient-to-b from-black/90 to-transparent">
              <button 
                ...
                className="p-2 bg-white/10 backdrop-blur-md rounded-full active:scale-90 transition-transform"
              >
                <ChevronLeft size={28} />
              </button>
              <button 
            ...
            {/* Bottom Info Overlay */}
            <div className="absolute bottom-0 left-0 right-0 p-8 pb-10 bg-gradient-to-t from-black via-black/80 to-transparent z-[2002] pointer-events-none">
               <h2 className="text-xl font-black italic uppercase tracking-tighter leading-tight">
                 {selectedVideo.caption}
               </h2>
               <p className="text-xs text-zinc-400 mt-2 font-bold uppercase tracking-widest">{selectedVideo.views} views</p>
            </div>
          </div>
        )}
      </div>
